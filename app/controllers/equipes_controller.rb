class EquipesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @equipe.save
        format.html { redirect_to equipes_path, notice: "Equipe criada com sucesso!" }
  ...
  def update
    respond_to do |format|
      if @equipe.update(equipe_params)
        format.html { redirect_to equipes_path, notice: "Equipe atualizada com sucesso!" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to equipes_path, status: :see_other, notice: "Equipe deletada com sucesso!" }
